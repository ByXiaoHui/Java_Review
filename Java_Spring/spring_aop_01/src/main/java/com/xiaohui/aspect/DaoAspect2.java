...
public class DaoAspect2 {
    ...
    public void methodBefore(JoinPoint joinPoint){
        System.out.println("methodBefore2 invoke... ...");
    ...
    public void methodAfter(JoinPoint joinPoint){
        System.out.println("methodAfter2 invoke... ...");
    }
    ...
    public void methodAfterReturning(JoinPoint joinPoint,Object res){
        System.out.println("methodAfterReturning2 invoke... ...");
    }
    ...
    public void methodAfterThrowing(Exception exception){
        System.out.println("methodAfterThrowing2 invoke... ...");
    }
    ...
    public Object methodAround(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        System.out.println("methodAroundA2 invoke... ...");
        Object proceed = proceedingJoinPoint.proceed();//控制切点方法在这里执行
        System.out.println("methodAroundB2 invoke... ...");
        return proceed;
    }
}
